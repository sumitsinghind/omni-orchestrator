...
Place your Google Cloud service account key file at server/services/vertex-service-account.json.

Run the script to create your first admin user: node createAdmin.js
...
/api/auth/reset-password-with-answer
...
Contact
Sumit Singh - sumitsingh.ay@gmail.com - LinkedIn

Project Link: https://github.com/sumitsinghind/omni-orchestrator
